...
'<dt>Terrain</dt>':'<dt>Рельеф</dt>',
'<dt>Vegetation</dt>':'<dt>Растительность</dt>',
'<dt>Type</dt>':'<dt>Тип</dt>',
...
'Ground accessibility and vegetation density.':'Доступность земли и густота растительности.',
'Detailed ground and terrain capture.':'Детальная съёмка земли и рельефа.',
'Both recommended':'Рекомендуем «Оба»',
'Get exact quote':'Получить точный расчёт',
'Request a quote':'Запросить расчёт',
'Indicative estimate based on land size and selected conditions. Final price may vary after a quick site review, depending on access, obstacles and required deliverables.':'Ориентировочная оценка по площади участка и выбранным условиям. Итоговая цена может измениться после быстрого осмотра площадки — в зависимости от доступа, препятствий и нужного набора результатов.',
'Add-ons':'Дополнительно',
'Add to your project':'Дополнить проект',
'Extend your site scan with additional data, visualization and development services.':'Дополните скан участка данными, визуализацией и услугами для проектирования.',
'360&deg; Panorama':'Панорама 360°',
'From 3,000 THB':'от 3 000 THB',
...
'An immersive digital representation of the real site combining spatial data and visual capture.':'Иммерсивное цифровое представление реального участка, объединяющее пространственные данные и визуальную съёмку.',
'Gaussian Splatting / 3D capture':'Gaussian Splatting / 3D-съёмка',
'Repeated 3D site capture to document construction progress and preserve a digital record of what has been built.':'Повторная 3D-съёмка участка для фиксации хода строительства и цифрового архива уже построенного.',
