...
'data-service="lidar" type="button">LiDAR Scan</button>':'data-service="lidar" type="button">LiDAR-скан</button>',
'data-service="drone" type="button">Drone Scan</button>':'data-service="drone" type="button">Скан с дрона</button>',
...
'data-terrain="open" type="button">Open</button>':'data-terrain="open" type="button">Открытый</button>',
'data-terrain="moderate" type="button">Moderate</button>':'data-terrain="moderate" type="button">Средний</button>',
'data-terrain="dense" type="button">Rugged</button>':'data-terrain="dense" type="button">Сложный</button>',
...
'Open &mdash; flat, minimal cover. Moderate &mdash; rolling, light cover. Rugged &mdash; steep, dense cover. LiDAR only; drone scans are tiered by area.':
 'Открытый — ровный, почти без растительности. Средний — холмистый, лёгкая растительность. Сложный — крутой, густая растительность. Только для LiDAR; сканы с дрона считаются по диапазонам площади.',
