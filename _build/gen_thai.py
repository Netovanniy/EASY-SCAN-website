...
'data-service="lidar" type="button">LiDAR Scan</button>':'data-service="lidar" type="button">สแกน LiDAR</button>',
'data-service="drone" type="button">Drone Scan</button>':'data-service="drone" type="button">สแกนด้วยโดรน</button>',
...
'data-terrain="open" type="button">Open</button>':'data-terrain="open" type="button">โล่ง</button>',
'data-terrain="moderate" type="button">Moderate</button>':'data-terrain="moderate" type="button">ปานกลาง</button>',
'data-terrain="dense" type="button">Rugged</button>':'data-terrain="dense" type="button">ขรุขระ</button>',
'<span class="price-label">Estimated price</span>':'<span class="price-label">ราคาโดยประมาณ</span>',
'Open &mdash; flat, minimal cover. Moderate &mdash; rolling, light cover. Rugged &mdash; steep, dense cover. LiDAR only; drone scans are tiered by area.':
 'โล่ง — ราบ พืชปกคลุมน้อย · ปานกลาง — ลอนเนิน พืชปกคลุมบาง · ขรุขระ — ชัน พืชปกคลุมหนา · ใช้กับ LiDAR เท่านั้น การสแกนด้วยโดรนคิดตามช่วงพื้นที่',
