...
'Ground cover; denser is harder to scan.':'พืชปกคลุมพื้นดิน ยิ่งหนายิ่งสแกนยาก',
'LiDAR per rai, drone by area, or both together.':'LiDAR ต่อไร่ โดรนตามพื้นที่ หรือใช้ทั้งสองอย่างร่วมกัน',
'Indicative figure, not a fixed quote. The final price is set after a short site review &mdash; access, obstructions and the deliverables you need can change it.':'ตัวเลขโดยประมาณ ไม่ใช่ราคาตายตัว ราคาสุดท้ายกำหนดหลังการตรวจสอบพื้นที่สั้น ๆ &mdash; การเข้าถึง สิ่งกีดขวาง และผลงานที่คุณต้องการอาจทำให้เปลี่ยนแปลงได้',
