...
'Team':'ทีมงาน',
'The people behind':'บุคคลเบื้องหลัง',
...
'Gaussian Splatting reconstructs a scene with remarkable visual fidelity, preserving natural lighting, textures and fine detail directly from photographs rather than a traditional 3D mesh. It runs in any web browser, letting you explore the site remotely, review conditions with your team and share it with clients and partners without installing software.':
 'Gaussian Splatting สร้างฉากขึ้นใหม่ด้วยความสมจริงของภาพที่โดดเด่น รักษาแสงธรรมชาติ พื้นผิว และรายละเอียดเล็ก ๆ ไว้โดยตรงจากภาพถ่าย แทนที่จะใช้เมช 3 มิติแบบดั้งเดิม ทำงานได้ในเว็บเบราว์เซอร์ทุกตัว ให้คุณสำรวจพื้นที่จากระยะไกล ทบทวนสภาพปัจจุบันร่วมกับทีม และแบ่งปันกับลูกค้าและพันธมิตรได้โดยไม่ต้องติดตั้งโปรแกรม',
...
'A Digital Twin is more than a 3D model. It is a digital representation of a real-world environment. We combine LiDAR, drone mapping, Gaussian Splatting and photogrammetry to recreate landscapes and developments in accurate, immersive 3D.<br>Terrain, vegetation, roads and structures become an interactive environment that can be explored from any angle.':
 'Digital Twin เป็นมากกว่าโมเดล 3 มิติ มันคือภาพแทนดิจิทัลของสภาพแวดล้อมในโลกจริง เรารวม LiDAR การทำแผนที่ด้วยโดรน Gaussian Splatting และโฟโตแกรมเมทรี เพื่อสร้างภูมิทัศน์และโครงการขึ้นใหม่ในแบบ 3 มิติที่แม่นยำและสมจริง<br>ภูมิประเทศ พืชพรรณ ถนน และสิ่งปลูกสร้าง กลายเป็นสภาพแวดล้อมโต้ตอบที่สำรวจได้จากทุกมุม',
...
'Every landscape has unique challenges, from slopes and vegetation to access and drainage, that 2D plans cannot fully reveal. EASY SCAN transforms real land into immersive 3D environments using LiDAR, drone mapping and Gaussian Splatting, allowing architects, developers and landowners to explore the terrain and test ideas before construction begins.':
 'ทุกภูมิทัศน์มีความท้าทายเฉพาะตัว ตั้งแต่ความลาดชันและพืชพรรณ ไปจนถึงทางเข้าและการระบายน้ำ ซึ่งแบบแปลน 2 มิติไม่สามารถแสดงได้อย่างครบถ้วน EASY SCAN แปลงที่ดินจริงให้เป็นสภาพแวดล้อม 3 มิติแบบสมจริง ด้วย LiDAR การทำแผนที่ด้วยโดรน และ Gaussian Splatting ให้สถาปนิก นักพัฒนา และเจ้าของที่ดินสำรวจภูมิประเทศและทดสอบแนวคิดได้ก่อนเริ่มก่อสร้าง',
...
'Construction changes fast, and critical details often disappear beneath finished surfaces. EASY SCAN captures each stage through 3D scanning, creating a clear visual record that helps developers, architects, contractors and investors track progress and understand exactly what has been built.':
 'งานก่อสร้างเปลี่ยนแปลงอย่างรวดเร็ว และรายละเอียดสำคัญมักหายไปใต้ผิวงานที่เสร็จแล้ว EASY SCAN เก็บภาพทุกช่วงของงานด้วยการสแกน 3 มิติ สร้างบันทึกภาพที่ชัดเจน ซึ่งช่วยให้นักพัฒนา สถาปนิก ผู้รับเหมา และนักลงทุนติดตามความคืบหน้าและเข้าใจได้อย่างชัดเจนว่าสร้างอะไรไปแล้วบ้าง',
...
'Need assistance?<br>Fill in the form below.<br>We\'ll get back to you within 24 hours.<br>You can also call us or send us an email.':
 'ต้องการความช่วยเหลือ?<br>กรอกแบบฟอร์มด้านล่าง<br>เราจะติดต่อกลับภายใน 24 ชั่วโมง<br>หรือจะโทรหาเราหรือส่งอีเมลถึงเราก็ได้',
...
'Pricing':'ราคา',
'Flat terrain — small height variation':'ภูมิประเทศราบ — ความสูงต่างกันเล็กน้อย',
'Sloped terrain — rolling, inclined relief':'ภูมิประเทศลาดเอียง — เป็นลอนเนินและลาดเท',
'Steep terrain — strong elevation difference':'ภูมิประเทศชัน — ความสูงต่างกันมาก',
...
'EASY SCAN pricing for LiDAR scanning, drone photogrammetry and 3D site visualisation in Koh Phangan, Koh Samui and Phuket. Instant estimate by land area plus fixed-rate services.':
 'ราคาบริการ EASY SCAN สำหรับการสแกน LiDAR โฟโตแกรมเมทรีด้วยโดรน และการแสดงภาพพื้นที่ 3 มิติ บนเกาะพะงัน เกาะสมุย และภูเก็ต ประเมินราคาทันทีตามพื้นที่ พร้อมบริการราคาคงที่',
'Rates for land scanning, 3D modelling and site visualisation across Koh Phangan, Koh Samui and Phuket. Get an instant estimate by land area below, or request a quote for larger and multi-site projects.':
 'อัตราค่าบริการสแกนที่ดิน การสร้างแบบจำลอง 3 มิติ และการแสดงภาพพื้นที่ บนเกาะพะงัน เกาะสมุย และภูเก็ต ประเมินราคาตามพื้นที่ได้ทันทีด้านล่าง หรือขอใบเสนอราคาสำหรับโครงการขนาดใหญ่และหลายพื้นที่',
'Estimate':'ประเมินราคา',
'Estimate by land area':'ประเมินราคาตามพื้นที่',
'Choose a service and move the slider to your plot size. Figures are indicative and confirmed after a site review.':
 'เลือกบริการแล้วเลื่อนแถบให้ตรงกับขนาดที่ดินของคุณ ตัวเลขเป็นค่าประมาณและจะยืนยันหลังการตรวจสอบพื้นที่',
'Fixed price':'ราคาคงที่',
'Estimated from area':'ประเมินจากพื้นที่',
'Custom quote':'ใบเสนอราคาเฉพาะงาน',
'data-service="lidar" type="button">LiDAR</button>':'data-service="lidar" type="button">LiDAR</button>',
'data-service="drone" type="button">Drone</button>':'data-service="drone" type="button">โดรน</button>',
'data-service="both" type="button">Both</button>':'data-service="both" type="button">ทั้งสอง</button>',
'<span class="field-label">Type</span>':'<span class="field-label">ประเภท</span>',
'<label for="raiRange" class="field-label">Land size</label>':'<label for="raiRange" class="field-label">ขนาดที่ดิน</label>',
'<span class="field-label">Terrain</span>':'<span class="field-label">ลักษณะภูมิประเทศ</span>',
'<span class="field-label">Vegetation</span>':'<span class="field-label">พืชพรรณ</span>',
'<dt>Terrain</dt>':'<dt>ภูมิประเทศ</dt>',
'<dt>Vegetation</dt>':'<dt>พืชพรรณ</dt>',
'<dt>Type</dt>':'<dt>ประเภท</dt>',
'data-terrain="flat" type="button">Flat</button>':'data-terrain="flat" type="button">ราบ</button>',
'data-terrain="sloped" type="button">Sloped</button>':'data-terrain="sloped" type="button">ลาดเอียง</button>',
'data-terrain="steep" type="button">Steep</button>':'data-terrain="steep" type="button">ชัน</button>',
'data-vegetation="clear" type="button">Clear</button>':'data-vegetation="clear" type="button">โล่ง</button>',
'data-vegetation="light" type="button">Light</button>':'data-vegetation="light" type="button">บาง</button>',
'data-vegetation="dense" type="button">Dense</button>':'data-vegetation="dense" type="button">หนา</button>',
'<span class="price-label">Estimated price</span>':'<span class="price-label">ราคาโดยประมาณ</span>',
'Slope of the land, from flat to steep.':'ความลาดชันของพื้นที่ ตั้งแต่ราบจนถึงชัน',
'Ground accessibility and vegetation density.':'การเข้าถึงพื้นดินและความหนาแน่นของพืชพรรณ',
'Detailed ground and terrain capture.':'การเก็บข้อมูลพื้นดินและภูมิประเทศอย่างละเอียด',
'Both recommended':'แนะนำแบบทั้งสอง',
'Get exact quote':'ขอราคาที่แน่นอน',
'Request a quote':'ขอใบเสนอราคา',
'Indicative estimate based on land size and selected conditions. Final price may vary after a quick site review, depending on access, obstacles and required deliverables.':'ราคาโดยประมาณจากขนาดที่ดินและเงื่อนไขที่เลือก ราคาสุดท้ายอาจเปลี่ยนแปลงหลังการตรวจสอบพื้นที่อย่างรวดเร็ว ขึ้นอยู่กับการเข้าถึง อุปสรรค และผลงานที่ต้องการ',
'Add-ons':'บริการเสริม',
'Add to your project':'เพิ่มให้กับโครงการของคุณ',
'Extend your site scan with additional data, visualization and development services.':'ต่อยอดการสแกนพื้นที่ด้วยข้อมูล การสร้างภาพ และบริการพัฒนาเพิ่มเติม',
'360&deg; Panorama':'ภาพพาโนรามา 360°',
'From 3,000 THB':'เริ่มต้น 3,000 บาท',
...
'An immersive digital representation of the real site combining spatial data and visual capture.':'ภาพแทนดิจิทัลแบบสมจริงของพื้นที่จริง ผสานข้อมูลเชิงพื้นที่เข้ากับการเก็บภาพ',
'Gaussian Splatting / 3D capture':'Gaussian Splatting / การเก็บภาพ 3 มิติ',
'Repeated 3D site capture to document construction progress and preserve a digital record of what has been built.':'การเก็บข้อมูล 3 มิติของพื้นที่ซ้ำ ๆ เพื่อบันทึกความคืบหน้าการก่อสร้างและเก็บบันทึกดิจิทัลของสิ่งที่สร้างไปแล้ว',
'Fixed rate':'ราคาคงที่',
'Fixed-rate services':'บริการราคาคงที่',
'Standard deliverables, priced as-is.':'งานส่งมอบมาตรฐาน ราคาตายตัว',
'<span class="label-primary">Highlight</span>':'<span class="label-primary">ไฮไลต์</span>',
'<span class="label-primary">Drone footage</span>':'<span class="label-primary">ฟุตเทจโดรน</span>',
'<span class="label-primary">Consultancy</span>':'<span class="label-primary">ให้คำปรึกษา</span>',
'360&deg; panorama':'ภาพพาโนรามา 360°',
'1-min video':'วิดีโอ 1 นาที',
'raw 5 min':'ฟุตเทจดิบ 5 นาที',
'First view 1,500 THB &middot; +500 THB each additional':'มุมแรก 1,500 บาท · เพิ่มมุมละ 500 บาท',
'Edited aerial &amp; ground footage, up to 60 seconds':'ฟุตเทจทางอากาศและภาคพื้นตัดต่อแล้ว ไม่เกิน 60 วินาที',
'Unedited aerial footage, delivered as-is':'ฟุตเทจทางอากาศแบบไม่ตัดต่อ ส่งมอบตามที่ถ่ายได้',
'First 2h 5,000 THB &middot; +3,000 THB each next hour':'2 ชม.แรก 5,000 บาท · ชม.ถัดไปชม.ละ 3,000 บาท',
'Scoped to your project':'กำหนดขอบเขตตามโครงการของคุณ',
'Larger work is scoped after a short call or site visit.':'งานขนาดใหญ่จะกำหนดขอบเขตหลังพูดคุยสั้น ๆ หรือเข้าสำรวจพื้นที่',
'Concept Testing':'ทดสอบแนวคิด',
'Construction Monitoring':'ติดตามงานก่อสร้าง',
'Multi-site / large-area projects':'โครงการหลายพื้นที่ / พื้นที่ขนาดใหญ่',
'A living 3D model of a site, kept current across the project lifecycle.':'แบบจำลอง 3 มิติของพื้นที่ที่อัปเดตต่อเนื่องตลอดอายุโครงการ',
'Test building placement, levels and massing on the real terrain before construction.':'ทดสอบตำแหน่งอาคาร ระดับ และมวลอาคารบนภูมิประเทศจริงก่อนก่อสร้าง',
'Recurring scans that track progress against the model.':'การสแกนซ้ำเป็นระยะเพื่อติดตามความคืบหน้าเทียบกับแบบจำลอง',
'Sites spanning multiple plots or with extended access logistics.':'พื้นที่ที่คร่อมหลายแปลงหรือมีการเข้าถึงที่ซับซ้อน',
'Request a quote &rarr;':'ขอใบเสนอราคา →',
'LiDAR + photogrammetry &middot; indicative pricing in THB, confirmed after site review.':'LiDAR + โฟโตแกรมเมทรี · ราคาโดยประมาณเป็นเงินบาท ยืนยันหลังตรวจสอบพื้นที่',
'Tell us about your site':'บอกเราเกี่ยวกับพื้นที่ของคุณ',
'Send the location and size of your land. We will confirm the price and respond within 24 hours.':'ส่งที่ตั้งและขนาดที่ดินของคุณมา เราจะยืนยันราคาและติดต่อกลับภายใน 24 ชั่วโมง',
